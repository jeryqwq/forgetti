...
import type { HookRegistration, ImportDefinition, Options, Preset } from './presets';
export type ComponentNode = t.ArrowFunctionExpression | t.FunctionExpression | t.FunctionDeclaration;
